...
> 👋 **欢迎！** 如果你是第一次使用这个项目，完全不懂编程，请先阅读 [SETUP.md](./SETUP.md) 中的"第一次使用完整流程"部分。

本项目包含三个子项目，支持 **Docker 运行** 和 **本地运行** 两种方式。

**什么是 Docker？什么是本地运行？**
- **Docker 运行**：所有服务（数据库、后端、前端）都在 Docker 容器中运行，最简单，推荐新手使用
- **本地运行**：后端和前端在你的电脑上直接运行，只有数据库在 Docker 中，适合需要调试代码的情况

**我应该选择哪种方式？**
- 如果你是新手，**强烈推荐使用 Docker 模式**，更简单，不容易出错
- 如果你需要调试代码或修改代码，可以使用本地模式
