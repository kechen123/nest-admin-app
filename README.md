...
> **🎯 新手必读**：如果您是第一次接触本项目，请先阅读 [项目启动指南](./START.md)

### 主要文档

- **[项目启动指南](./START.md)** ⭐ - **从这里开始！** 包含完整的启动、开发、部署流程
  - 本地启动项目（Docker / 本地 npm/pnpm/yarn）
  - 后端开发文档
  - Web 端开发文档
  - 文档系统
  - 部署指南（本地打包上传 / 服务器自动部署）
...
- **[项目启动指南](./START.md)** ⭐ - 完整的启动、开发、部署流程（推荐新手阅读）
...
- [部署指南](./DEPLOYMENT.md) - 完整的部署流程和问题排查
- [快速部署指南](./QUICK_DEPLOY.md) - 简化版部署流程
