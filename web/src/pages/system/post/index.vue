<template>
  <TableWithSlidePanel :config="kcConfig" :column-display-config="columnDisplayConfig" ref="tableRef">
    <template #actions="{ row }">
      <el-button type="primary" plain size="small" @click="openPostDetail(row.id, 'edit')">编辑</el-button>
      <el-button type="success" plain size="small" @click="openPostDetail(row.id, 'view')">查看详情</el-button>
